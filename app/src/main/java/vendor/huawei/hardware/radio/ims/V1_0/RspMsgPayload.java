...
/* loaded from: RspMsgPayload.class */
public final class RspMsgPayload {
    ...
    public static final ArrayList<RspMsgPayload> readVectorFromParcel(HwParcel hwParcel) {
        ArrayList<RspMsgPayload> arrayList = new ArrayList<>();
        ...
        for (int i = 0; i < int32; i++) {
            ...
            rspMsgPayload.readEmbeddedFromParcel(hwParcel, readEmbeddedBuffer, i * 56);
            arrayList.add(rspMsgPayload);
        }
        return arrayList;
    }

    public static final void writeVectorToParcel(HwParcel hwParcel, ArrayList<RspMsgPayload> arrayList) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj == null || obj.getClass() != RspMsgPayload.class) {
            return false;
        }
        RspMsgPayload rspMsgPayload = (RspMsgPayload) obj;
        return this.nData == rspMsgPayload.nData && HidlSupport.deepEquals(this.nDatas, rspMsgPayload.nDatas) && HidlSupport.deepEquals(this.strData, rspMsgPayload.strData) && HidlSupport.deepEquals(this.strDatas, rspMsgPayload.strDatas);
    }
