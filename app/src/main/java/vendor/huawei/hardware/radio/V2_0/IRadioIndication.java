...
public interface IRadioIndication extends IBase {
    ...
    public static final class Proxy implements IRadioIndication {
        ...
        @Override // vendor.huawei.hardware.radio.V2_0.IRadioIndication, android.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        @Override // vendor.huawei.hardware.radio.V2_0.IRadioIndication
        ...
        @Override // vendor.huawei.hardware.radio.V2_0.IRadioIndication, android.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IRadioIndication {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-68, 15, -32, -115, 99, -27, -78, 79, 75, -15, -124, 6, 35, 13, 2, 36, -113, -24, 26, 21, Byte.MIN_VALUE, -40, -90, 82, -76, -78, -23, -74, AnswerToReset.EUICC_SUPPORTED, -66, -121, 111}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, AnswerToReset.EUICC_SUPPORTED, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}));
        }
