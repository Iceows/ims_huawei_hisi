    ...
    public static abstract class Stub extends HwBinder implements IRadioIms {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(
                    new byte[]{15, -6, 20, 51, 39, -83, -112, -86, -19, -120, -22, 48, -46, 99, 105, 12, 63, -66, 28, -66, 54, 0, -111, 90, -116, -3, -14, -32, 32, 16, 93, 9},
                    new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}));
        }

        @Override // vendor.huawei.hardware.radio.ims.V1_0.IRadioIms
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IRadioIms.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case RadioError.DIAL_MODIFIED_TO_DIAL /* 20 */:
                    if (!((i2 & 1) != 0)) {
                        hwParcel2.writeStatus(Integer.MIN_VALUE);
                        hwParcel2.send();
                        return;
                ...
                case RadioError.USSD_MODIFIED_TO_USSD /* 23 */:
                    if (!((i2 & 1) != 0)) {
                        hwParcel2.writeStatus(Integer.MIN_VALUE);
                        hwParcel2.send();
                        return;
                ...
                case RadioError.SS_MODIFIED_TO_DIAL /* 24 */:
                    if (!((i2 & 1) != 0)) {
                        hwParcel2.writeStatus(Integer.MIN_VALUE);
                        hwParcel2.send();
                        return;
                ...
                case 25:
                    ...
                    return;
                case RadioError.SUBSCRIPTION_NOT_SUPPORTED /* 26 */:
                    if (!((i2 & 1) != 0)) {
                        hwParcel2.writeStatus(Integer.MIN_VALUE);
                        hwParcel2.send();
                        return;
                ...
                case 27:
                    ...
                    return;
                case LastCallFailCause.INVALID_NUMBER_FORMAT /* 28 */:
                    if (!((i2 & 1) != 0)) {
                        hwParcel2.writeStatus(Integer.MIN_VALUE);
                        hwParcel2.send();
                        return;
                    ...
                    return;
                case LastCallFailCause.FACILITY_REJECTED /* 29 */:
                    if (!((i2 & 1) != 0)) {
                        hwParcel2.writeStatus(Integer.MIN_VALUE);
                        hwParcel2.send();
                        return;
                    ...
                    return;
                case LastCallFailCause.RESP_TO_STATUS_ENQUIRY /* 30 */:
                    if (!((i2 & 1) != 0)) {
                        hwParcel2.writeStatus(Integer.MIN_VALUE);
                        hwParcel2.send();
                        return;
                ...
                case LastCallFailCause.NORMAL_UNSPECIFIED /* 31 */:
                    if (!((i2 & 1) != 0)) {
                        hwParcel2.writeStatus(Integer.MIN_VALUE);
                        hwParcel2.send();
                        return;
