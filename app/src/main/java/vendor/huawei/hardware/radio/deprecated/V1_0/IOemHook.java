...
public interface IOemHook extends IBase {
    ...
    public static final class Proxy implements IOemHook {
        ...
        @Override // vendor.huawei.hardware.radio.deprecated.V1_0.IOemHook, android.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        @Override // vendor.huawei.hardware.radio.deprecated.V1_0.IOemHook
        public void setResponseFunctions(IOemHookResponse oemHookResponse, IOemHookIndication oemHookIndication) throws RemoteException {
            ...
            _hidl_request.writeStrongBinder(oemHookIndication != null ? oemHookIndication.asBinder() : null);
        ...
        @Override // vendor.huawei.hardware.radio.deprecated.V1_0.IOemHook, android.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IOemHook {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IOemHook.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{22, -93, 1, 30, -37, 113, 41, 53, -73, -100, -66, 113, -45, -101, AnswerToReset.DIRECT_CONVENTION, -30, 48, -6, 75, 87, 119, -41, -125, -80, 0, 7, 82, -127, -71, -72, -21, -89}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, AnswerToReset.EUICC_SUPPORTED, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}));
        }
            ...
            switch (_hidl_code) {
                ...
                case 3:
                    ...
                    if (_hidl_index_0 != 1) {
                        ...
                        sendRequestStrings(serial2, data2);
                        return;
                    }
                case 256067662:
                    _hidl_is_oneway = (_hidl_flags & 1) != 0;
