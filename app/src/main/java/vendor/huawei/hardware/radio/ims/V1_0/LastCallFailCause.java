...
public final class LastCallFailCause {
    ...
    public static final String dumpBitfield(int i) {
        ...
        int i46 = i45;
        if ((i & MESSAGE_NOT_COMPATIBLE_WITH_PROTOCOL_STATE) == 101) {
            arrayList.add("MESSAGE_NOT_COMPATIBLE_WITH_PROTOCOL_STATE");
            i46 = i45 | MESSAGE_NOT_COMPATIBLE_WITH_PROTOCOL_STATE;
        }
        int i47 = i46;
        if ((i & RECOVERY_ON_TIMER_EXPIRED) == 102) {
            arrayList.add("RECOVERY_ON_TIMER_EXPIRED");
            i47 = i46 | RECOVERY_ON_TIMER_EXPIRED;
        }
        int i48 = i47;
        ...
        int i65 = i64;
        if ((i & RADIO_LINK_LOST) == 255) {
            arrayList.add("RADIO_LINK_LOST");
            i65 = i64 | RADIO_LINK_LOST;
        }
        int i66 = i65;
        if ((i & RADIO_UPLINK_FAILURE) == 256) {
            arrayList.add("RADIO_UPLINK_FAILURE");
            i66 = i65 | RADIO_UPLINK_FAILURE;
        }
        int i67 = i66;
        ...
        int i74 = i73;
        if ((i & CDMA_INTERCEPT) == 1002) {
            arrayList.add("CDMA_INTERCEPT");
            i74 = i73 | CDMA_INTERCEPT;
        }
        int i75 = i74;
        if ((i & CDMA_REORDER) == 1003) {
            arrayList.add("CDMA_REORDER");
            i75 = i74 | CDMA_REORDER;
        }
        int i76 = i75;
        if ((i & CDMA_SO_REJECT) == 1004) {
            arrayList.add("CDMA_SO_REJECT");
            i76 = i75 | CDMA_SO_REJECT;
        }
        int i77 = i76;
        if ((i & CDMA_RETRY_ORDER) == 1005) {
            arrayList.add("CDMA_RETRY_ORDER");
            i77 = i76 | CDMA_RETRY_ORDER;
        }
        int i78 = i77;
        if ((i & CDMA_ACCESS_FAILURE) == 1006) {
            arrayList.add("CDMA_ACCESS_FAILURE");
            i78 = i77 | CDMA_ACCESS_FAILURE;
        }
        int i79 = i78;
        if ((i & CDMA_PREEMPTED) == 1007) {
            arrayList.add("CDMA_PREEMPTED");
            i79 = i78 | CDMA_PREEMPTED;
        }
        int i80 = i79;
