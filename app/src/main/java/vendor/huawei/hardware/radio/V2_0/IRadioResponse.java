...
public interface IRadioResponse extends IBase {
    ...
    public static final class Proxy implements IRadioResponse {
        ...
        @Override // vendor.huawei.hardware.radio.V2_0.IRadioResponse, android.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        @Override // vendor.huawei.hardware.radio.V2_0.IRadioResponse, android.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IRadioResponse {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{15, 34, 114, -67, 99, -117, -25, 34, 98, 64, -88, -51, 37, 89, 109, -65, -104, 42, -69, -122, -63, 60, 80, -3, -5, -25, 30, -44, 93, -38, 54, -111}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, AnswerToReset.EUICC_SUPPORTED, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}));
        }
