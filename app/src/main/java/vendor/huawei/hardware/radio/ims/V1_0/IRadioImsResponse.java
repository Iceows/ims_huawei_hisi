...
public interface IRadioImsResponse extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IRadioImsResponse {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(
                    new byte[]{-43, -102, 7, -4, 56, -126, 14, -4, 40, Byte.MIN_VALUE, 86, -32, -15, -61, -9, 105, 16, 47, 2, -76, -113, 109, 4, 114, 73, -18, -115, -91, 69, 21, 30, -67},
                    new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, -126, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}));
        }

        @Override // vendor.huawei.hardware.radio.ims.V1_0.IRadioImsResponse
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IRadioImsResponse.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
    ...
    static IRadioImsResponse asInterface(IHwBinder binder) {
        ...
        IRadioImsResponse proxy = new IRadioImsResponse.Proxy(binder);
        try {
