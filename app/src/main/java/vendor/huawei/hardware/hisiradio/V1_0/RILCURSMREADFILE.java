...
public final class RILCURSMREADFILE {
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.appType))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.fileId))));
    }

    public final String toString() {
        return "{.appType = " + RILCURSMAPPTYPEENUM.toString(this.appType) + ", .fileId = " + this.fileId + "}";
    }
