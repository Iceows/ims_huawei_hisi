...
public final class RILImsSrvstatusList {
    ...
    public final void readFromParcel(HwParcel parcel) {
        HwBlob blob = parcel.readBuffer(264L);
    ...
    public static final ArrayList<RILImsSrvstatusList> readVectorFromParcel(HwParcel parcel) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 264, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            RILImsSrvstatusList _hidl_vec_element = new RILImsSrvstatusList();
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 264);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<RILImsSrvstatusList> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * 264);
        }
