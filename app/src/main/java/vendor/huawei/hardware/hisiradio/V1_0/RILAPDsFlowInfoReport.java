...
public final class RILAPDsFlowInfoReport {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        parcel.readEmbeddedBuffer(this.totalTxFlow.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 80 + 0, false);
        this.totalRxFlow = _hidl_blob.getString(_hidl_offset + 96);
        parcel.readEmbeddedBuffer(this.totalRxFlow.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 96 + 0, false);
    }
