...
public final class RILCallModify {
    ...
    public final boolean equals(Object otherObject) {
        ...
        RILCallModify other = (RILCallModify) otherObject;
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.callIndex))));
    }

    public final String toString() {
        return "{.callIndex = " + this.callIndex + "}";
    }
