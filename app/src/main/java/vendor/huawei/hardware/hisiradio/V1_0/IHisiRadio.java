...
public interface IHisiRadio extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IHisiRadio {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IHisiRadio.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    IHisiRadioResponse radioResponse = IHisiRadioResponse.asInterface(_hidl_request.readStrongBinder());
                    IHisiRadioIndication radioIndication = IHisiRadioIndication.asInterface(_hidl_request.readStrongBinder());
