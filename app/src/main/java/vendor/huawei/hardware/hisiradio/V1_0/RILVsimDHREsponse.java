...
public final class RILVsimDHREsponse {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        parcel.readEmbeddedBuffer(this.cPubkey.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 8 + 0, false);
        this.sPubkey = _hidl_blob.getString(_hidl_offset + 24);
        parcel.readEmbeddedBuffer(this.sPubkey.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 24 + 0, false);
    }
