...
public interface IHisiRadioIndication extends vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioIndication {
    public static final String kInterfaceName = "vendor.huawei.hardware.hisiradio@1.1::IHisiRadioIndication";

    @Override // vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioIndication, android.hidl.base.V1_0.IBase, android.os.IHwInterface
    IHwBinder asBinder();

    void currentHwSignalStrength_1_1(int i, HwSignalStrength_1_1 hwSignalStrength_1_1) throws RemoteException;
    ...
    void updateUlfreqRPT(int i, int i2, int i3, int i4) throws RemoteException;
    ...
    public static final class Proxy implements IHisiRadioIndication {
        ...
        @Override // vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioIndication, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioIndication, android.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.hisiradio@1.1::IHisiRadioIndication]@Proxy";
            }
        }
        ...
        @Override // vendor.huawei.hardware.hisiradio.V1_1.IHisiRadioIndication, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioIndication, android.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IHisiRadioIndication {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IHisiRadioIndication.kInterfaceName, vendor.huawei.hardware.hisiradio.V1_0.IHisiRadioIndication.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{98, -58, -111, 89, -53, -93, -123, 64, 84, 110, -34, 72, 36, 28, 115, -24, 52, 1, 91, 54, 121, -59, 90, -24, 39, -91, 19, -121, 3, 49, 58, -66}, new byte[]{-104, 16, -32, -88, 19, 68, 21, -48, -110, 43, -63, -96, 52, 31, -93, -98, -43, -51, -117, -105, -42, -10, -115, -90, -29, 126, 117, 78, 99, -120, 8, -28}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, AnswerToReset.EUICC_SUPPORTED, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, 15, -39}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 8:
                    int ulfreq = _hidl_flags & 1;
                    _hidl_index_0 = ulfreq != 0 ? 1 : 0;
                    if (_hidl_index_0 != 1) {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
                        return;
                ...
                case 9:
                    ...
                    int rat2 = _hidl_request.readInt32();
                    int ulfreq2 = _hidl_request.readInt32();
                    int ulbw = _hidl_request.readInt32();
                    updateUlfreqRPT(type9, rat2, ulfreq2, ulbw);
                    return;
                case 10:
                    _hidl_index_0 = (_hidl_flags & 1) != 0 ? 1 : 0;
                    if (_hidl_index_0 != 1) {
                    ...
                    currentHwSignalStrength_1_1(type10, sigStrength);
                    return;
                default:
                    switch (_hidl_code) {
                        case 256067662:
