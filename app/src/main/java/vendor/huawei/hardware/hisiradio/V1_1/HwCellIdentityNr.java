...
public final class HwCellIdentityNr {
    public int ci;
    public int earfcn;
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != HwCellIdentityNr.class) {
            return false;
        }
        HwCellIdentityNr other = (HwCellIdentityNr) otherObject;
    ...
    public static final ArrayList<HwCellIdentityNr> readVectorFromParcel(HwParcel parcel) {
        ArrayList<HwCellIdentityNr> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16L);
        int _hidl_vec_size = _hidl_blob.getInt32(8L);
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 48, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            HwCellIdentityNr _hidl_vec_element = new HwCellIdentityNr();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<HwCellIdentityNr> _hidl_vec) {
