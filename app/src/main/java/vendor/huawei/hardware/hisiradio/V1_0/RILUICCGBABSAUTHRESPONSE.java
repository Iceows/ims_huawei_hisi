...
public final class RILUICCGBABSAUTHRESPONSE {
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.authStatus))), Integer.valueOf(HidlSupport.deepHashCode(this.resData)), Integer.valueOf(HidlSupport.deepHashCode(this.authSyncfail)));
    }

    public final String toString() {
        return "{.authStatus = " + RILUICCAUTHRESPSTATUSTYPEENUM.toString(this.authStatus) + ", .resData = " + this.resData + ", .authSyncfail = " + this.authSyncfail + "}";
    }
