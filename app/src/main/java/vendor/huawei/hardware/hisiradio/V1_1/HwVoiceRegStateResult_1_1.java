...
public final class HwVoiceRegStateResult_1_1 {
    public final HwCellIdentity_1_1 cellIdentity = new HwCellIdentity_1_1();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != HwVoiceRegStateResult_1_1.class) {
            return false;
        }
        HwVoiceRegStateResult_1_1 other = (HwVoiceRegStateResult_1_1) otherObject;
    ...
    public static final ArrayList<HwVoiceRegStateResult_1_1> readVectorFromParcel(HwParcel parcel) {
        ArrayList<HwVoiceRegStateResult_1_1> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16L);
        int _hidl_vec_size = _hidl_blob.getInt32(8L);
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 144, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            HwVoiceRegStateResult_1_1 _hidl_vec_element = new HwVoiceRegStateResult_1_1();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<HwVoiceRegStateResult_1_1> _hidl_vec) {
