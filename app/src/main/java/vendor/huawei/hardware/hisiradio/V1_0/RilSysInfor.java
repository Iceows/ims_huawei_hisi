...
public final class RilSysInfor {
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.infoType))), Integer.valueOf(HidlSupport.deepHashCode(this.nDatas)));
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.infoType = _hidl_blob.getInt32(_hidl_offset + 0);
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ...
            this.nDatas.add(Integer.valueOf(_hidl_vec_element));
        }
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 >= _hidl_vec_size) {
                ...
                childBlob.putInt32(_hidl_index_02 * 4, this.nDatas.get(_hidl_index_02).intValue());
