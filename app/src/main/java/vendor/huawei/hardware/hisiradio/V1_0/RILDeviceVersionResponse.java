...
public final class RILDeviceVersionResponse {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        parcel.readEmbeddedBuffer(this.buildTime.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 0 + 0, false);
        this.externalSwVersion = _hidl_blob.getString(_hidl_offset + 16);
        parcel.readEmbeddedBuffer(this.externalSwVersion.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 16 + 0, false);
        this.internalSwVersion = _hidl_blob.getString(_hidl_offset + 32);
        parcel.readEmbeddedBuffer(this.internalSwVersion.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 32 + 0, false);
        this.externalDbVersion = _hidl_blob.getString(_hidl_offset + 48);
        parcel.readEmbeddedBuffer(this.externalDbVersion.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 48 + 0, false);
        this.internalDbVersion = _hidl_blob.getString(_hidl_offset + 64);
        parcel.readEmbeddedBuffer(this.internalDbVersion.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 64 + 0, false);
        this.externalHwVersion = _hidl_blob.getString(_hidl_offset + 80);
        parcel.readEmbeddedBuffer(this.externalHwVersion.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 80 + 0, false);
        this.internalHwVersion = _hidl_blob.getString(_hidl_offset + 96);
        parcel.readEmbeddedBuffer(this.internalHwVersion.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 96 + 0, false);
        this.externalDutName = _hidl_blob.getString(_hidl_offset + 112);
        parcel.readEmbeddedBuffer(this.externalDutName.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 112 + 0, false);
        this.internalDutName = _hidl_blob.getString(_hidl_offset + 128);
        parcel.readEmbeddedBuffer(this.internalDutName.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 128 + 0, false);
        this.configurateVersion = _hidl_blob.getString(_hidl_offset + 144);
        parcel.readEmbeddedBuffer(this.configurateVersion.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 144 + 0, false);
        this.prlVersion = _hidl_blob.getString(_hidl_offset + 160);
        parcel.readEmbeddedBuffer(this.prlVersion.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 160 + 0, false);
    }
