...
public final class RILEOPLmnResponse {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        parcel.readEmbeddedBuffer(this.version.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 0 + 0, false);
        this.pduLen = _hidl_blob.getInt32(_hidl_offset + 16);
        this.pdu = _hidl_blob.getString(_hidl_offset + 24);
        parcel.readEmbeddedBuffer(this.pdu.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 24 + 0, false);
    }
